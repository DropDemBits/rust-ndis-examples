...
impl INetCfgComponentControl_Impl for CMuxNotify_Impl {
    fn Initialize(
        &self,
        picomp: Ref<INetCfgComponent>,
        pinetcfg: Ref<INetCfg>,
        finstalling: BOOL,
    ) -> Result<()> {
        Ok(())
    }
    ...
    fn ApplyPnpChanges(&self, picallback: Ref<INetCfgPnpReconfigCallback>) -> Result<()> {
        Ok(())
    }
...
impl INetCfgComponentSetup_Impl for CMuxNotify_Impl {
...
impl INetCfgComponentNotifyBinding_Impl for CMuxNotify_Impl {
    fn QueryBindingPath(&self, dwchangeflag: u32, pipath: Ref<INetCfgBindingPath>) -> Result<()> {
        Err(E_NOTIMPL.into())
    }

    fn NotifyBindingPath(&self, dwchangeflag: u32, pipath: Ref<INetCfgBindingPath>) -> Result<()> {
        Err(E_NOTIMPL.into())
    }
}

impl INetCfgComponentNotifyGlobal_Impl for CMuxNotify_Impl {
    ...
    fn SysNotifyComponent(&self, dwchangeflag: u32, picomp: Ref<INetCfgComponent>) -> Result<()> {
        Err(E_NOTIMPL.into())
    }
}

impl INetCfgComponentPropertyUi_Impl for CMuxNotify_Impl {
    fn QueryPropertyUi(&self, punkreserved: Ref<IUnknown>) -> Result<()> {
        Err(E_NOTIMPL.into())
    }

    fn SetContext(&self, punkreserved: Ref<IUnknown>) -> Result<()> {
        Err(E_NOTIMPL.into())
    }
